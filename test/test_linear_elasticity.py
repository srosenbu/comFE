...
D = np.array(
    [
        [lambda_ + 2.0 * mu, lambda_, lambda_, 0.0, 0.0, 0.0],
        [lambda_, lambda_ + 2.0 * mu, lambda_, 0.0, 0.0, 0.0],
        [lambda_, lambda_, lambda_ + 2.0 * mu, 0.0, 0.0, 0.0],
...
model1 = co.laws.PyLinearElastic3D(parameters)
model2 = co.laws.PyLinElas3D(parameters)

...
// //#[cfg(feature = "python-bindings")]
// macro_rules! implement_python_model {
//     ($name:ident, $model:ty, $tr:path) => {
//         #[pyclass]
//         pub struct $name{model: $model}
//         #[pymethods]
//         impl $name {
//             fn evaluate(
//                 &self,
...
//                 tangent: Option<PyReadwriteArray1<f64>>,
...
//                     match tangent {
//                         Some(tangent) => {
//                             Some(tangent.as_slice_mut().unwrap())
//                         }
//                         None => {
//                             None
//                         }
...
// implement_python_model!(PyMisesPlasticity3D, MisesPlasticity3D, ConstitutiveModelFn<6, 2, 7, 4, 4>);

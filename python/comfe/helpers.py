...
class TimestepEstimator:
    def __init__(self, mesh, G, K, rho, safety_factor=1.0, order=1):
        ...
        self.cells = dfx.cpp.mesh.entities_to_geometry(
        ...
        self.h_cell = dfx.cpp.mesh.entities_to_geometry(
...
def critical_timestep(
    l_x, l_y, G, K, rho, cell_type=dfx.mesh.CellType.quadrilateral, order=1
):
